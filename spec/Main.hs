...
feedTests = do
  describe "atom feed" $ do
    it "should make an atom feed" $ do
  ...
  describe "rss feed" $ do
    it "should make an rss 2.0 feed" $ do
      ...
      let wpfeed = WPFeed
                     ...
                     (renderFeedContent ctxt)
      ft <- toXMLFeed (_wordpress ctxt) wpfeed
      ft `shouldBe` "<rss version=\"2.0\"><channel><title>My Blog</title><link>https://myurl.com/feed</link><description/><docs>http://www.rssboard.org/rss-specification</docs><language>en-us</language><pubDate>Thu,  2 Oct 2014 07:00:00 UTC</pubDate><lastBuildDate>Thu,  2 Oct 2014 07:00:00 UTC</lastBuildDate><ttl>60</ttl><item><title>&lt;i&gt;Foo&lt;/i&gt; bar</title><link>https://myurl.com/2014/10/foo-bar/</link><description>summary</description><author>rss@jacobin.com (Emma Goldman)</author><pubDate>Thu,  2 Oct 2014 07:00:00 UTC</pubDate></item></channel></rss>"
...
larcenyFillTests = do
  describe "<wpPosts>" $ do
    ...
    it "should allow formating of dates" $
      ...
      \  </wpDate> \
      \</wpPosts>" `shouldRender` "October 2, 2014"
